...
local sets = {
    ...
    Idle_Refresh = {
        Ammo = 'Homiliary',
        Neck = 'Coatl Gorget +1',
		 Head = { Name = 'Odyssean Helm', Augment = { [1] = 'Weapon Skill Acc.+18', [2] = 'Accuracy+14', [3] = '"Refresh"+2', [4] = 'Magic burst dmg.+10%', [5] = 'Attack+14' } },
		Body = 'Jumalik Mail',
    ...
    Phalanx = {
        ...
        Ear1 = 'Odnowa Earring +1',
        Ear2 = 'Andoaa Earring',
        Body = { Name = 'Odyss. Chestplate', Augment = { [1] = '"Fast Cast"+1', [2] = 'Mag. Acc.+16', [3] = 'Phalanx +4', [4] = 'AGI+7', [5] = '"Mag. Atk. Bns."+16' } },
...
profile.HandleMidcast = function()
	...
	elseif string.match(spell.Name, 'Protect V') then
        gFunc.EquipSet(sets.Protect);
